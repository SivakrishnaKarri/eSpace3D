...
#pragma warning restore 0414
		...
		//public GameObject contentParentWarning;
...
#pragma warning restore 0649
		...
		internal DebugLogItem PopLogItem()
		{
			...
			if ( pooledLogItems.Count > 0 )
			{
				...
				//newLogItem1 = pooledLogItems[pooledLogItems.Count - 1];
				//pooledLogItems.RemoveAt(pooledLogItems.Count - 1);
				//newLogItem1.gameObject.SetActive(true);
		...
		/*public Transform ClearAllChildren(this Transform parentTransform)
		{
